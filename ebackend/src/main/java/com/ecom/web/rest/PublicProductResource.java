...
public class PublicProductResource {
    ...
    public PublicProductResource(ProductService productService, ProductRepository productRepository) {
    ...
    public ResponseEntity<List<ProductDTO>> searchProducts(
        ...
        log.debug("REST request to get a page of Products");
        List<ProductDTO> productDTOS = productService.searchProducts(query, categoryId);
