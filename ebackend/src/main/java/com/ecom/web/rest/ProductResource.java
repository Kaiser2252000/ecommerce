...
/**
 * REST controller for managing {@link com.ecom.domain.Product}.
 */
@RestController
@RequestMapping("/api/admin")
public class ProductResource {

    public static String uploadDir = System.getProperty("user.dir") + "/src/main/webapp/content/productImages";
    ...
    public ResponseEntity<ProductDTO> createProduct(@Valid @RequestBody ProductDTO productDTO) throws URISyntaxException {
        ...
        return ResponseEntity
            .created(new URI("/admin/api/products/" + result.getId()))
    ...
    @PostMapping("/products/saveImage")
    @PreAuthorize("hasAuthority(\"" + AuthoritiesConstants.ADMIN + "\")")
    ...
    @GetMapping("/products/nopageable")
    @PreAuthorize("hasAuthority(\"" + AuthoritiesConstants.ADMIN + "\")")
    public ResponseEntity<List<ProductDTO>> getAllProductsNoPageable() {
        log.debug("REST request to get all Products");
        List<ProductDTO> productDTOS = productService.findAllNoPageable();
