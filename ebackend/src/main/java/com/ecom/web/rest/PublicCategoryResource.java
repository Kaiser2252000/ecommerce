...
/**
 * REST controller for managing {@link com.ecom.domain.Category}.
 */
@RestController
@RequestMapping("/api")
public class PublicCategoryResource {
    ...
    public PublicCategoryResource(CategoryService categoryService, CategoryRepository categoryRepository) {
    ...
    public ResponseEntity<List<CategoryDTO>> searchCategory(
        ...
        log.debug("REST request to get a page of Categories");
        Page<CategoryDTO> page = categoryService.searchCategories(pageable, search);
        HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(ServletUriComponentsBuilder.fromCurrentRequest(), page);
        return ResponseEntity.ok().headers(headers).body(page.getContent());
    }

    @GetMapping("/categories/nopageable")
    public ResponseEntity<List<CategoryDTO>> getAllCategoriesNoPageble() {
        log.debug("REST request to get all Categories");
        List<CategoryDTO> categoryDTOList = categoryService.findAllNoPageableStatusTrue();
