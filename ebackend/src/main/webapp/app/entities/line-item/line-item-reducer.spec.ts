...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './line-item.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LINEITEM_LIST actions', async () => {
    ...
    it('dispatches FETCH_LINEITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LINEITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LINEITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LINEITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LINEITEM actions', async () => {
      const expectedActions = [
        {
